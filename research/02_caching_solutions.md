...
В данном разделе проводится глубокий анализ существующих решений для распределенного кэширования моделей машинного обучения в бессерверном (serverless) инференсе. Основное внимание уделяется архитектурным особенностям, преимуществам и недостаткам, а также применимости таких систем, как Alluxio, JuiceFS, Dragonfly, CubeFS и Rook/Ceph, для обеспечения высокой доступности.
