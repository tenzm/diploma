...
#abstract(
  ...
  *Объект исследования* --- инфраструктура бессерверного инференса моделей машинного обучения, развернутая в среде Kubernetes с применением механизма масштабирования до нуля (scale-to-zero).
